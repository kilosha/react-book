    ...
    return (
        <div>
            ...
            <Typography paragraph>
                ...
                того, функциональный он или классовый. Пропсы являются неизменяемыми (immutable), их
                нельзя изменять напрямую. Если нужно изменить данные в дочернем компоненте, следует
                использовать состояние (state).
            </Typography>
